...
ICONS=(nfc-chip:nfc-tag nfc-chip-10x10:nfc-tag-hud contact-card insight-report request-chips luggage-single luggage-pair luggage-group)
...
TILES=(coatroom-tiles2:coatroom2 garage-tile:garage belldesk-tile:belldesk)
